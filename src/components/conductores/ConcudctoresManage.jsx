...
const ConductoresManage = ({Conductores}) => {
    ...
    const handleSelect = (user) => {
        setSelectedConductor(user);
        handleOpenConductorUpd();
    }
    ...
    if (Conductores === undefined || Conductores.length === 0) {
    ...
    export default ConductoresManage;