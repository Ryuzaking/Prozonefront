    ...
    return (
        ...
        />
          <section className="w-full ">
           <nav className="w-full flex justify-end text-end items-end px-8"> <div className="bg-blue-300 shadow-md rounded-bl-2xl rounded-tr-2xl w-fit "><h1 className=" font-bold text-2xl p-4 text-gray-100">Gestionar Colaboradores</h1></div></nav>
            <div className="p-4">
