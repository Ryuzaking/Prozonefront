import { UpdateModalProv } from "./modales/modal";
import { useState } from "react";
import { Toaster } from "react-hot-toast";

const ManageProveedores = ({Proveedores}) => {
    const [open, setOpen] = useState(false);
    const [selectedProveedores, setSelectedProveedores] = useState({});
    const handleOpenProv = () => setOpen(true);
    const handleCloseProv = () => setOpen(false);
    const handleSelect = (user) => {
        setSelectedProveedores(user);
        handleOpenProv();
    }
    ...
    return (
        ...
        <UpdateModalProv 
            open={open}
            handleOpen={handleOpenProv}
            handleClose={handleCloseProv}
        ...
        />
          <section className="w-full">
            <div className="bg-gray-200 shadow-md rounded-bl-2xl rounded-tr-2xl w-fit"><h1 className="font-bold text-2xl p-4 text-gray-500">Gestionar Proveedores</h1></div>
            <div className="p-4">
